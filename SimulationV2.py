...
def main():
    ...
    ap.add_argument("--base-radius", type=float, default=3.2, help="sphere radius")
    ap.add_argument("--circle-angle-deg", type=float, default=2.5, help="ring angle from tangent")
    ap.add_argument("--circle-height", type=float, default=0.25, help="ring cylinder height")
    ap.add_argument("--hex-length", type=float, default=0.5, help="box height along local u")
    ap.add_argument("--rect-half-width", type=float, default=None, help="override half width along t1")
    ap.add_argument("--rect-half-length", type=float, default=None, help="override half length along t2")
    ap.add_argument("--lock-cross-section", action="store_true", help="keep ring and box cross section independent from base radius")
    args = ap.parse_args()

    # ---------- Parameters ----------
    base_radius = 2.3 #args.base_radius
    ...
    # If locked, use a fixed reference so shrinking the sphere does not shrink attachments
    ...
    # Base visual and collision from mesh
    ...
    # ---------- Solid rectangular prisms as true boxes ----------
    def mat3_to_quat(r):
    ...
    for top_center, u in cylinder_tops:
        ...
        p.changeVisualShape(body, -1, specularColor=[0.0, 0.0, 0.0])
        box_bodies.append(body)

    # Supports visual and collision from mesh
